...
# Extract Los Angeles, Detroit MSA parcel records
unzip -c $ASSESSOR_MASTER_FILE | awk -F "|" '{ if ($1 == 06037 || $1 == 06059) print }' > $DQ_DATA_DIR/TaxAssessor_filtered_LosAngeles.txt
unzip -c $ASSESSOR_MASTER_FILE | awk -F "|" '{ if ($1 == 26099 || $1 == 26125 || $1 == 26163 || $1 == 26087 || $1 == 26093 || $1 == 26147) print }' > $DQ_DATA_DIR/TaxAssessor_filtered_Detroit.txt

# Extract Los Angeles, Detroit transactions records
unzip -c $TRANSACTIONS_MASTER_FILE | awk -F "|" '{ if (($1 == "" && $29 == "MI") || ($1 == 26163 || $1 == 26125 || $1 == 26099 || $1 == 26087 || $1 == 26093 || $1 == 26147)) print }' > $DQ_DATA_DIR/Transactions_filtered_Detroit.txt
