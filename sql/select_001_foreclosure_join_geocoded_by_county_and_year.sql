...
SELECT fc.recording_date, fc.record_type, fc.unique_id_notice, fc.mm_fips_county_name, fc.doc_type, fc.ft_site_city, fc.ft_site_zip, fc.fd_delinquent_date, fc.fd_nod_t_auct_date, fc.ft_not_sale_date,
       left(fc.recording_date::text, 4) AS recording_year, 
       ST_Transform(ST_SetSRID(ST_MakePoint(gc.x, gc.y), 4326), 32617) AS geom
  --INTO _temp_foreclosures_by_year_
