...
SELECT sa_property_id, lot_size_sqft, sa_bldg_sqft, built_area_sqft, net_unbuilt_area_sqft, garage_present, garage_attached, garage_detached, pool_present, year_built, year_improved,
